...
return a.innerHTML='<label for="checkbox-for-'+e+'" class="add-to-calendar-label">+ Add to my Calendar</label>',a.innerHTML+='<input name="add-to-calendar-checkbox" class="add-to-calendar-checkbox" id="checkbox-for-'+e+'" type="checkbox">',Object.keys(t).forEach(function(o){a.innerHTML+=t[o]}),a.className="add-to-calendar",void 0!==o&&(a.className+=" "+o),a.id=e,a},d=function(t){return t.options&&t.options["class"]?t.options["class"]:void 0},s=function(t){return t.options&&t.options.id?t.options.id:Math.floor(1e6*Math.random())}
